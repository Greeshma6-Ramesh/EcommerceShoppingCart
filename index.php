      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 1" style="height: 600px;">
            <img src="../photos/laptop.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 1">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 2" style="height: 600px;">
            <img src="../photos/iphone.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 2">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 3" style="height: 600px;">
            <img src="../photos/ipadpro.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 3">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 4" style="height: 600px;">
            <img src="../photos/Airpods.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 4">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 5" style="height: 600px;">
            <img src="../photos/Watch.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 5">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 6" style="height: 600px;">
            <img src="../photos/AppleTv.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 6">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 7" style="height: 600px;">
            <img src="../photos/Pencil.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 7">
            <div class="card-body">
      ...
      <div class="col">
       <div class="card">
          <div class="card-img" alt="Product 8" style="height: 600px;">
            <img src="../photos/Mouse.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 8">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 9" style="height: 600px;">
            <img src="../photos/AirTag.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 9">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 10" style="height: 600px;">
            <img src="../photos/trackpad.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 10">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 11" style="height: 600px;">
            <img src="../photos/Folio.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 11">
            <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <div class="card-img" alt="Product 12" style="height: 600px;">
            <img src="../photos/homepod.png" weidth="600px" height="600px" class="img-fluid img-thumbnail" alt="Product 12">
            <div class="card-body">
